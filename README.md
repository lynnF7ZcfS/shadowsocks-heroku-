...
## 部署
1. 点击 
[![](https://www.herokucdn.com/deploy/button.png)](https://heroku.com/deploy?template=https://github.com/tetsaicn/shadowsocks-heroku-/tree/re)，[一键部署到heroku](https://heroku.com/deploy?template=https://github.com/tetsaicn/shadowsocks-heroku-/tree/re)
...
2. 修改config.json参数,server是服务器地址，将onplus改成你的应用名称，password是你设置的密码，method是加密方式，其它选项请不要动，然后 运行ss-h.exe 或 start.vbs (或 [win托盘工具taskbar.exe](https://github.com/onplus/shadowsocks-heroku/issues/39))
